...
import com.example.pricechecker.fragments.ImageResult;
...
public class ProductActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Places.initialize(getApplicationContext(), "AIzaSyD9SdaEdGX5K3gTucLtQhyarfR7F--_QuU");
...
//                                    Log.e(TAG, document.getId() + " => " + document.getData());
        ...
        Call<JsonObject> call = jsonPlaceHolderApi.getPosts(parameter);
        ...
        text2.setText(itemTitle);
        text3.setText(itemPrice);
        text4.setText(itemSource);
        Picasso
                .get()
                .load(thumbnailUrl)
                .resize(300, 300)
            ...
            placeResult.addOnCompleteListener(new OnCompleteListener<FindCurrentPlaceResponse>() {
                ...
                public void onComplete(@NonNull Task<FindCurrentPlaceResponse> task) {
                    if (task.isSuccessful() && task.getResult() != null) {
                        ...
                        ProductActivity.this.openPlacesDialog();
                    } else {
                        Log.e(TAG, "Exception: %s", task.getException());
                    }
                }
